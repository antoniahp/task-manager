...
@status_columns_router.post("/status_columns", response=IdentifierSchema)
...
@status_columns_router.get("/status_columns/{status_column_id}", response=GetStatusColumnsSchema)
